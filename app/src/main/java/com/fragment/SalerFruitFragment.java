...
public class SalerFruitFragment extends Fragment {
    ...
    private SalerFruitAdapter salerFruitAdapter;
    private String mParam1;
    private String mParam2;



    public static SalerFruitFragment newInstance(String param1, String param2) {
        SalerFruitFragment fragment = new SalerFruitFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        salerFruitAdapter = new SalerFruitAdapter(fruitList);
        rvOnsalePrduct.setAdapter(salerFruitAdapter);
        return view;
    }
    ...
    public void updateFruitList(){
        ...
        fruitList.clear();
        fruitList = productDao.queryBuilder().where(ProductDao.Properties.Category.eq(Constants.TYPE_FRUIIT)).list();
        salerFruitAdapter.notifyDataSetChanged();
    }
