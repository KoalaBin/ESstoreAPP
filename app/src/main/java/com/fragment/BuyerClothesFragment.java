...
import com.adapter.BuyerClothesAdapter;
...
public class BuyerClothesFragment extends Fragment {
    ...
    private BuyerClothesAdapter buyerClothesAdapter;
    ...
    public static BuyerClothesFragment newInstance(String param1, String param2) {
        BuyerClothesFragment fragment = new BuyerClothesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buyerClothesAdapter = new BuyerClothesAdapter(clothesList);
        rvOnsalePrduct.setAdapter(buyerClothesAdapter);
        return view;
    }
